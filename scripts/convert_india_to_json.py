#!/usr/bin/env python3
"""
Convert india.json TSV file to proper JSON format matching usa.json structure
"""
...
def parse_tsv_to_json(input_file, output_file):
    ...
    for i, line in enumerate(lines):
        ...
        record = {
            ...
            "location": parts[10].strip() if len(parts) > 10 else "India",
...
if __name__ == "__main__":
    input_file = "src/data/india.json"
    output_file = "src/data/india.json"
