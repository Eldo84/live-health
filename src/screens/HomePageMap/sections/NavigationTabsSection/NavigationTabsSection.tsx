...
export const NavigationTabsSection = (): JSX.Element => {
  // Commented out header section with Feed, Community, Fund project, Docta +, RxMarkets
  return null;
  // return (
  //   <nav className="w-full lg:w-[420px] h-[44px] border-b border-[#FFFFFF33] overflow-x-auto">
  //     <Tabs defaultValue="feed" className="w-full h-full">
  //       <TabsList className="inline-flex items-start gap-[13px] bg-transparent h-auto p-0 border-0 min-w-max">
